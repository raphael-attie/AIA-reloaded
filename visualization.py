...
class RGBMixer:
    ...
    def __init__(self, data_dir=None, wavel_dirs=None, data_files=None, outputdir=None, ref=0, crop=None, filename_lab=None, filename_rgb=None):
        """
        ...
        :param crop: (y,x)=(rows, cols) coordinates for cropping. E.g (slice(0,1024), slice(100,3200))
...
def process_rgb_image(i, data_files, rgblow, rgbhigh, gamma_rgb=(2.8, 2.8, 2.4), scalemin=0, rgbmix=None, lab=None, lmin=0, crop=None, filename_rgb=None, filename_lab=None):
    """
